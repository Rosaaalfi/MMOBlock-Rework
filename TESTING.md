...
|---------------------------------|------------|--------------|-----------------|--------------|----------------|-----------------------------------------------------------------------------------------|
| **1.19.4 (Mojang) Paper/Folia** | ✅         | ✅           | ✅              | ✅           | ✅             | Base stable                                                                             |
| **1.19.4 (Spigot) Paper/Folia** | ✅         | ✅           | ✅              | ✅           | ✅             | Base stable                                                                             |
| **1.20.4 (Mojang) Paper/Folia** | ✅         | ✅           | ✅              | ✅           | ✅             | Background hologram transparency fixed                                                  |
| **1.20.4 (Spigot) Paper/Folia** | ✅         | ✅           | ✅              | ✅           | ✅             | Background hologram transparency fixed                                                  |
| **1.21.1 Paper**                | ✅         | ✅           | ✅              | ✅           | ✅             | Basic load verified — Plugin detected & enabled correctly after Java 25→21 bytecode fix |
| **1.21.4 Paper/Folia**          | ✅         | ✅           | ✅              | ✅           | ✅             | Basic load verified                                                                     |
...
| **1000 mass-spawn**                 | Spawn rate   | >17.5       | 1000 spawned ✅  |
| **1000 mass-remove**                | Remove rate  | >17.5       | 1000 removed ✅  |
...
| **500 block place**          | Write time       | <5ms per block | **11,462ms (22.9ms/block)** 🟡 |
| **500 block break**          | Delete time      | <5ms per block | **12,925ms (25.9ms/block)** 🟡 |
...
- [x] Block placement (BDEngine)
- [x] Block placement (Schematic)
- [x] Block interaction (click)
- [x] Block mining progress
- [x] Block break
- [x] Block respawn
- [x] Particle effects
- [x] Sound effects
- [x] Holograms (text & item)
- [x] Hologram animations
- [x] Break animation
- [x] Node system
- [x] Drop system (vanilla)
- [x] Conditions (placeholder)
- [x] Database persist H2
- [x] Chunk load/unload
- [x] Plugin disable/cleanup
- [x] Rejoin server

### Per Platform

#### Paper
- [x] Single-thread scheduler
- [x] Bukkit events
- [x] Packet handling
- [x] Plugin compatibility
- [x] bStats metrics sent (check https://bstats.org)
- [x] Update checker (check console on startup)
...
- [x] Thread safety
- [x] World ownership
- [x] bStats metrics sent
- [x] Update checker

### Per Integration

#### MMOItems
- [x] Soft dependency load
- [x] Item matching (allowedTools)
- [x] Item drops
- [x] Custom durability
...
- [x] Level conditions
- [x] EXP rewards
- [x] Profession EXP rewards
- [x] Attribute conditions
...
- [x] Item drops
- [x] Custom durability
- [x] Custom block placement
- [x] Custom block removal
...
#### ModelEngine
- [x] Soft dependency load
- [x] Model spawn (entity-based)
- [x] Model scale
- [x] Animation (onClick, onDead)
- [x] Model cleanup on break

#### BetterModel
- [x] Soft dependency load
- [x] Model spawn (entity-based)
- [x] Model spawn (location-based)
- [x] Model scale
- [x] Animation
- [x] Model cleanup on break

#### PlaceholderAPI
- [x] Placeholder expansion registered
- [x] `%mmoblock_progress%`
- [x] `%mmoblock_max_progress%`
- [x] `%mmoblock_respawn_time%`
- [x] Conditional placeholders
...
#### Schematics
- [x] Normal schematic load
- [x] Dead schematic change
- [x] Facing rotation
- [x] Position adjustment
- [x] Multi-block schematic
...
- [x] Max blocks limit
- [x] Random location
- [x] Closest solid block check
- [x] Block list display
- [x] Individual block respawn

#### Drops
- [x] Vanilla item drops
- [x] MMOItems drops
- [x] ItemsAdder drops
- [x] CraftEngine drops
- [x] Experience drops
...
#### Conditions
- [x] Placeholder-based condition
- [x] Comparison operators (>, <, >=, <=, ==, !=)
- [x] String comparison
- [x] Title/subtitle message
- [x] Condition display text
...
- **Java 25**: For NMS versions 26.1 (Paper/Folia) and 26.2 (Paper/Folia/Canvas)
...
>
> **Stress tested by:** Chyxel — DB stress (500 block write/delete), mass-spawn & mass-remove (1000 blocks)
>
