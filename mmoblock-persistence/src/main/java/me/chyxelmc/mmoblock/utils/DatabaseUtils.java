...
public final class DatabaseUtils {
    ...
    public void initializeH2(final JavaPlugin plugin) {
        ...
        // H2 no longer uses a password — empty string for no encryption.
        final HikariConfig hikariConfig = getHikariConfig(dbFile);
    ...
    private static @NonNull HikariConfig getHikariConfig(File dbFile) {
