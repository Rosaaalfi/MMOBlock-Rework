 ...
 */
package me.chyxelmc.mmoblock.utils.analytics;
...
public class Metrics {
    ...
    private static final String CFG_SERVER_UUID = "serverUuid";
    private static final String JSON_VALUES = "values";
    private static final String ERR_JSON_VALUES_NULL = "JSON values must not be null";
    ...
    public Metrics(Plugin plugin, int serviceId) {
        ...
        if (!config.isSet(CFG_SERVER_UUID)) {
            config.addDefault("enabled", true);
            config.addDefault(CFG_SERVER_UUID, UUID.randomUUID().toString());
        ...
        String serverUUID = config.getString(CFG_SERVER_UUID);
    ...
    public static class MetricsBase {
        ...
        private static final java.util.Set<String> ALLOWED_SSRF_HOSTS = java.util.Set.of("bstats.org");
        ...
        private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
            ...
            final java.net.URL parsed = new java.net.URL(url);
            final String host = parsed.getHost() != null ? parsed.getHost().toLowerCase(java.util.Locale.ROOT) : "";
            if (!ALLOWED_SSRF_HOSTS.contains(host)) {
                throw new java.lang.SecurityException("SSRF blocked: disallowed host '" + host + "'");
            }
    ...
    public static class DrilldownPie extends CustomChart {
        ...
        public JsonObjectBuilder.JsonObject getChartData() throws Exception {
            ...
            return new JsonObjectBuilder().appendField(JSON_VALUES, valuesBuilder.build()).build();
        }
    }
    ...
    public static class JsonObjectBuilder {
        ...
        public JsonObjectBuilder appendField(String key, String[] values) {
            if (values == null) {
                throw new IllegalArgumentException(ERR_JSON_VALUES_NULL);
            }
