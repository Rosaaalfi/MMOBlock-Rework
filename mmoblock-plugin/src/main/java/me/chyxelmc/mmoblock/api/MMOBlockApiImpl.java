...
public final class MMOBlockApiImpl implements BlockService, NodeService, me.chyxelmc.mmoblock.api.MMOBlockApi {
    ...
    @Override
    public me.chyxelmc.mmoblock.api.model.BlockDefinition getBlockDefinition(final String id) {
        return this.blockConfigService.findBlock(id);
    }
    ...
    @Override
    public me.chyxelmc.mmoblock.api.model.NodeDefinition getNodeDefinition(final String id) {
        return this.nodeConfigService.findNode(id);
    }
