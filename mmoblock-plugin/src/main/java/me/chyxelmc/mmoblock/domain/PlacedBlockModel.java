package me.chyxelmc.mmoblock.domain;
...
/**
 * Domain model for a placed block in the world. Tracks its position, status,
 * interaction entity, and respawn schedule.
 *
 * <p>Renamed from {@code PlacedBlockImpl} to align with the domain model naming
 * convention and to distinguish it from implementation-level classes.</p>
 */
public final class PlacedBlockModel implements me.chyxelmc.mmoblock.api.model.PlacedBlock {
