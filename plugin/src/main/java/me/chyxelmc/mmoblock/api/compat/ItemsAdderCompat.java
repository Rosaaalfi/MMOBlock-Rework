...
/**
 * Compatibility layer for <a href="https://itemsadder.devs.beer/">ItemsAdder</a>.
 * <p>
...
public final class ItemsAdderCompat {
    ...
    private static final Logger LOGGER = Logger.getLogger(ItemsAdderCompat.class.getName());
