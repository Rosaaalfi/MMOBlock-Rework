package me.chyxelmc.mmoblock.api.compat;
...
// All BetterModel API types are referenced ONLY inside method bodies
// guarded by AVAILABLE, so they use fully-qualified names to ensure the
// JVM never resolves them when BetterModel is not installed.

/**
 * Compatibility layer for <a href="https://github.com/toxicity188/BetterModel">BetterModel v3.x</a>.
 * <p>
 ...
 * </p>
 */
public final class BetterModelCompat {

    private static final boolean AVAILABLE;
    private static final Logger LOGGER = Logger.getLogger(BetterModelCompat.class.getName());
     ...
     * this compatibility layer. Useful for debugging or metrics.
     */
